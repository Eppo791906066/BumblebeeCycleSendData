 ...
 * EXTERNAL VARIABLES
 */
extern uint8 u8_wechatWriteCharFlag;
extern uint8 ReIndicateflag;
/*********************************************************************
 * EXTERNAL FUNCTIONS
 */
...
void OnBoard_KeyCallback_NUll( uint8 keys, uint8 state )
{
    #ifdef UART_DEBUG
        print_msg("OnBoard_KeyCallback_NUll \r\n" );
    #endif
}
void Board_Key_Disable(void)
{
    OnboardKeyIntEnable = HAL_KEY_INTERRUPT_DISABLE;
    HalKeyConfig( OnboardKeyIntEnable, OnBoard_KeyCallback_NUll);
}
void Board_Key_Enable(void)
{
    OnboardKeyIntEnable = HAL_KEY_INTERRUPT_ENABLE;
    HalKeyConfig( OnboardKeyIntEnable, OnBoard_KeyCallback);
}
